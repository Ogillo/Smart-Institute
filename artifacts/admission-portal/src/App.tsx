...
const clerkAppearance = {
  ...
  elements: {
    ...
    identityPreviewEditButton: "text-teal-700 hover:text-teal-800",
  ...
  return (
    ...
    >
      ...
      <Switch>
        ...
        <Route path="/portal/*?" component={DashboardRouter} />
        <Route path="/admin/*?" component={DashboardRouter} />
        <Route path="/super-admin/*?" component={DashboardRouter} />
